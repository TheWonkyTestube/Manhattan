...
require'fzf-lua'.setup {
  ...
  winopts = {
    ...
    width            = 0.32,            -- window width
    row              = 0.124,            -- window row position (0=top, 1=bottom)
  ...
  files = {
    ...
    cmd               = "fd . /home/will/ --hidden -E '.local' -E '.cache' -E 'ROMS' -E '.audacity-data' -E 'Backups' -E '.steam', -E '.icon', -E '.npm', -E '.cargo', -E '.java'",
